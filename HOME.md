...
<!-- regenerated 2026-09-10 — do not edit by hand -->
...
Generated from note frontmatter. To change anything above, edit the assignment
note — never this file.
...
- [[assignments-tracker]] — full tracker, including hand-maintained rows
- [[cei-study-plan]] · [[semester-schedule-2026]] · [[cei-regulations-summary]]
- `02-programming/guides/` — dev reference
- `00-inbox/` — unfiled captures

## Running the vault

| When | Do |
|---|---|
| Something changes | Edit the note's frontmatter. Nothing else. |
| Weekly, 10 min | Empty `00-inbox/`; mark finished work `submitted` |
| Monthly, 30 min | `bash _meta/check.sh` · archive + sweep refs · `du -sh .git` |

Rules: [[KOS]] · design: [[KOS-ARCHITECTURE]] · manual: [[KOS-MANUAL]]
