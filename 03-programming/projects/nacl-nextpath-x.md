...
- `scripts/vault-init.sh`: one-time setup for `~/KnowledgeVault/03-programming/<project>` with `state.md`, `decisions.md`, and `sessions/`.
...
- Home KnowledgeVault note created at `~/KnowledgeVault/03-programming/nacl-nextpath-x.md`.
